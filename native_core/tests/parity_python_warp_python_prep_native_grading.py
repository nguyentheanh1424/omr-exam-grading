...
OUTPUT_DIR = REPO_ROOT / "results" / "parity_python_warp_python_prep_native_grading"
...
def run_native_grading_on_python_prep(
    ...
    prepared_gray = omr._prep_gray(warped_img)
    result = client.run(
        prepared_gray,
        config,
