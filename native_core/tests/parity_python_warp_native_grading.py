...
OUTPUT_DIR = REPO_ROOT / "results" / "parity_python_warp_native_grading"
...
def run_native_grading_on_warp(
...
def main() -> None:
    ...
    for image_path in image_paths:
        ...
        native_result = run_native_grading_on_warp(client, warped)
        ...
        image_report = {
            ...
            "native_on_python_warp": native_result,
